...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		treegrid = $('#treegrid').treegrid({
			url : sy.bp() + '/system/role?treegrid',
			toolbar : [ {
				text : '展开',
				iconCls : 'icon-redo',
				handler : function() {
			...
			columns : [ [ {
				...
				editor : {
					type : 'combocheckboxtree',
					options : {
						url : sy.bp() + '/system/resource?tree',
						animate : false,
						cascadeCheck : false,
						lines : !sy.isLessThanIe8(),
						onLoadSuccess : function(node, data) {
